...
//Implement by aignacio
// void OLEDprintf(char *data_oled,uint8_t size_oled){
// 	uint16_t i = 0;
// 	*(data_oled+size_oled) = '\0';
// 	for(i = 0;i<(size_oled);i++){
// 		if(*(data_oled+i) == '$'){
// 			OLED_y++;
// 			OLED_x=0;
// 			OLED_Print(OLED_x, OLED_y, "@", 1);
// 			break;
// 		}
// 		else OLED_Print(OLED_x, OLED_y, (unsigned char *)(data_oled+i), 1);
// 		if(OLED_x >= size_OLED_x){
// 			if(OLED_y >= size_OLED_y){
// 				OLED_CLS();
// 				OLED_y = 0;
// 				OLED_x = 0;
// 			}
